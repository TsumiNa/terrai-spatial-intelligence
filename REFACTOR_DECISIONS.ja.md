...
第一段階は Factor of Concept であり schema、DB、orchestration を定義しませんでした。後続の展示リファクタは最小読取 API を追加しましたが三層境界は変えません。詳細は [`docs/architecture/FL_SL_AL_CONCEPT.ja.md`](docs/architecture/FL_SL_AL_CONCEPT.ja.md) と [`docs/adr/0001-fl-sl-al-conceptual-layers.ja.md`](docs/adr/0001-fl-sl-al-conceptual-layers.ja.md) を参照してください。
