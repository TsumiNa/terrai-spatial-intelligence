...
| [`data/`](data/catalog/README.md) | One subfolder per integrated FL dataset group, covering source, use, license, and commercial cautions | English default, Japanese and Chinese partners |
