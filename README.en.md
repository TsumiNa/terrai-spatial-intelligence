...
The frontend never reads `data/` directly. File locations, caching, filtering, aggregation, and ranking stay in Python. See [the call sequence diagrams](architecture/README.en.md).
...
- [Concept architecture](docs/architecture/FL_SL_AL_CONCEPT.en.md)
- [ADR-0001](docs/adr/0001-fl-sl-al-conceptual-layers.en.md)
- [Refactor record](docs/refactor/2026-07-fl-sl-al-factor-of-concept.en.md)
- [Frontend–backend call sequences](architecture/README.en.md)
...
- Complete usage, cost, and license analysis: [`DATA_SOURCES.en.md`](DATA_SOURCES.en.md).
...
Output: `data/mobara/tepco_grid_screen.json`. Download automation does not change TEPCO rights. Values rank regional discovery/pre-consultation only, not formal connection studies, and CSV geometry cannot allocate capacity to each cell. See `data/external/tepco/README.en.md`.
