...
- State: **In progress** — PR1 (drop slope basemap + 2.5D toggle + per-mode terrain) done; PR2 (hillshade colour-by-height tint) and PR3 (DEM-computed hillshade + DEM5A + optional 2× DPR) pending.
