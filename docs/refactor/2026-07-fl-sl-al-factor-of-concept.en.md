...
- ADR for rationale, alternatives, consequences, and non-goals.
...
- Connected README, concept, ADR, and refactor record.
...
6. Read `FL_SL_AL_CONCEPT.en.md` and the ADR internally and confirm the runtime never labels AL rules as SL.
