...
| 东京电力“系統の予想潮流等” | 已接入（受限） | 区域级空容量/上位约束预筛、并网咨询排序 | 免费公开 CSV | **非开放许可**；官方注意资料标注“転載禁止”，数值为暂定简化值且不保证接入。原 CSV 只保留内部可追溯，公开/商业再发布需权利复核和正式接续検討 |
...
- 数据：千叶县送电线与变电设备“系統の予想潮流等”CSV，公开日期 2026-06-22。
- 原始文件：本地可放置于 `data/external/tepco/`，但受“転載禁止”限制，不进入 Git 仓库；复现步骤见该目录的 `README.md`。
