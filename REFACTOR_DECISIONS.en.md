...
The first stage was a Factor of Concept and did not define schemas, databases, or orchestration. The later exhibition refactor added a minimal read-only API without changing the three-layer boundary. See [`docs/architecture/FL_SL_AL_CONCEPT.en.md`](docs/architecture/FL_SL_AL_CONCEPT.en.md) and [`docs/adr/0001-fl-sl-al-conceptual-layers.en.md`](docs/adr/0001-fl-sl-al-conceptual-layers.en.md).
...
- See `docs/architecture/FRONTEND_BACKEND_SPLIT.en.md`.
