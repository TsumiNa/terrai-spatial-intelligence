...
- State: **In progress** — PR1 (drop slope basemap + 2.5D toggle + per-mode terrain, #85) and PR2 (hillshade colour-by-height tint) done; PR3 (DEM-computed hillshade + DEM5A + optional 2× DPR) pending.
